...
describe Algorithms::PolyTreeNode do
  let(:node1) {Algorithms::PolyTreeNode.new('root') }
  let(:node2) { Algorithms::PolyTreeNode.new('child1') }
  let(:node3) { Algorithms::PolyTreeNode.new('child2') }

  describe "#initialize" do
    let(:new_node) { Algorithms::PolyTreeNode.new('new_node') }
...
describe 'Searchable' do
  let(:nodes) { ('a'..'g').map { |value| Algorithms::PolyTreeNode.new(value) } }
